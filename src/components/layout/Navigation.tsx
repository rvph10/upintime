        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="space-y-2">
              <span className={`block w-8 h-0.5 bg-primary transition-transform ${isMenuOpen ? 'rotate-45 translate-y-2.5' : ''}`} />
              <span className={`block w-8 h-0.5 bg-primary transition-opacity ${isMenuOpen ? 'opacity-0' : ''}`} />
              <span className={`block w-8 h-0.5 bg-primary transition-transform ${isMenuOpen ? '-rotate-45 -translate-y-2.5' : ''}`} />
            </div>
          </button>
        </div>
