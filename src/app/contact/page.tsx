...
export default function ContactPage() {
  return (
    <div className="w-full min-h-screen relative flex items-center justify-center px-5 py-16 md:p-0">
      ...
      <div
        ...
        font-bold uppercase text-xl sm:text-2xl md:text-3xl lg:text-6xl"
      >
        Get in <br />
        touch.
      </div>
      ...
      <div
        ...
        font-bold uppercase text-xl sm:text-2xl md:text-3xl lg:text-6xl text-right"
      >
        Drop us <br />a line.
      </div>
    </div>
